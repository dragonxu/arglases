...
import com.panxsoft.xiaojingxiuxiu.adapter.PronumberpopuAdapter;
...
//        this.setAnimationStyle(R.style.AnimBottom);
        ...
        name.setText("请选择新的库存（原来的库存："+text+"）");
        LinearLayoutManager manager = new LinearLayoutManager(context);
        recy.setLayoutManager(manager);
        PronumberpopuAdapter adapter = new PronumberpopuAdapter(context, parliball,numbers);
